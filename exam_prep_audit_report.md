...
### Category: Org Complexity & Governance
...
| Topic | Status | Matched Keywords |
| :--- | :--- | :--- |
| CloudFormation & StackSets | [COVERED] | cloudformation, template, stackset |

### Category: Observability & Security

| Topic | Status | Matched Keywords |
| :--- | :--- | :--- |
| CloudWatch & CloudTrail | [COVERED] | cloudwatch, cloudtrail, metric, alarm |
| AWS Config & Auditing | [COVERED] | aws config, compliance, remediat |
| KMS Encryption & Key Policies | [COVERED] | kms, envelope encryption, key policy |
