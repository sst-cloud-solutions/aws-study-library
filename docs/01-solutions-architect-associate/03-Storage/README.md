...
[⬅️ Previous: Compute](../02-Compute/README.md) | [Next: Database ➡️](../04-Database/README.md) | [📚 Main](../saa-roadmap.md)

---

## Prerequisites

- [Compute Services - Practice Questions](../02-Compute/PRACTICE-QUESTIONS.md)
