# Module 01: Identity and Access Management (IAM)
...
- ➡️ **Next**: [Module 01: Compute Services](../02-Compute/README.md)
- ⬅️ **Previous**: [AWS Fundamentals](../../00-it-foundation/10-aws-fundamentals/README.md)
...
[⬅️ Back to Main README](../saa-roadmap.md) | [Next Module: Compute ➡️](../02-Compute/README.md)
