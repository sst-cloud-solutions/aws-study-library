...
- **[INCORRECT-AREAS-FLASHCARDS.md](study-guides/INCORRECT-AREAS-FLASHCARDS.md)** - Focus on weak areas
- **[INCORRECT-AREAS-PRACTICE-QUESTIONS.md](study-guides/INCORRECT-AREAS-PRACTICE-QUESTIONS.md)** - Targeted practice
- **[PRACTICE-TEST-4-INCORRECT-STUDY-GUIDE.md](study-guides/PRACTICE-TEST-4-INCORRECT-STUDY-GUIDE.md)** - PT4 review
...
- **[CHANGELOG.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CHANGELOG.md)** - Version history
- **[CODE_OF_CONDUCT.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CODE_OF_CONDUCT.md)** - Community guidelines
- **[CONTRIBUTING.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CONTRIBUTING.md)** - How to contribute
- **[CONTRIBUTORS.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CONTRIBUTORS.md)** - Contributors list
- **[SECURITY.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/SECURITY.md)** - Security policies
- **[PROJECT-CLEANUP-SUMMARY.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/README.md)** - Cleanup notes
...
3. Review weak areas with [INCORRECT-AREAS-PRACTICE-QUESTIONS.md](study-guides/INCORRECT-AREAS-PRACTICE-QUESTIONS.md)

### For Contributors
1. Read [CONTRIBUTING.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CONTRIBUTING.md)
2. Review [CODE_OF_CONDUCT.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CODE_OF_CONDUCT.md)
3. Check [CHANGELOG.md](https://github.com/ChathurangaVKD/AWS-Certified-Solutions-Architect-Associate-SAA-C03/blob/main/CHANGELOG.md)

## 📊 Exam Reviews

All practice test reviews are stored in the **[exam-reviews/](../exam-reviews/README.md)** directory at the project root.

---

## Prerequisites

- [AWS SAA-C03 Exam Coverage Update Summary](exam-analysis/COVERAGE-UPDATE-SUMMARY.md)
