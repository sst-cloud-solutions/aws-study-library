...
:::note
**Real-World Analogy:** Renting a physical AWS rack and dropping it directly into your own on-premises data center, connecting it to the local power and network lines while control remains in AWS.
:::
...
| Feature | AWS Outposts | Local VM / VMware |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** aws outposts, local hardware rack, hybrid latency, local api consistency, physical control

Look for "sub-millisecond latency to on-premises resources" or local hardware regulatory requirements in the exam.
:::

:::warning
**Common Exam Traps:** Outposts must maintain a persistent network path to the parent AWS Region; it is not designed for offline operations.
:::
