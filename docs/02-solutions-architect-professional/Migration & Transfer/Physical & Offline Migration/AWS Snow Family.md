...
:::note
**Real-World Analogy:** A locked physical storage crate: instead of uploading 100 Terabytes over a slow internet route, you load the files onto a hard drive vault and ship it via courier.
:::
...
| Device Type | Capacity | Primary Use Case |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** snow family, snowball edge, snowcone, physical shipping data, offline migration

Use Snowball Edge when migrations exceed 10 TB and network connections are slow or unreliable.
:::

:::warning
**Common Exam Traps:** Ensure to prepare local compute configurations (e.g. NFS client mounts) to copy data at maximum speed.
:::
...
- [Migration Strategies (The 6R's)](../Migration Tools/Migration Strategies.md)

## Recommended Next Topics

- [Disaster Recovery Strategies](../../Storage/Backup & Disaster Recovery/Disaster Recovery Strategies.md)

## Related Topics

- [AWS Application Discovery Service](../Migration Tools/AWS Application Discovery Service.md)
- [AWS Application Migration Service (MGN)](../Migration Tools/AWS Application Migration Service.md)
- [AWS Database Migration Service](../Migration Tools/AWS Database Migration Service.md)
