:::note
**Real-World Analogy:** An API translation layer that lets external partners upload legacy files using traditional routes (SFTP/FTP) directly into a modern data lake storage bucket (S3).
:::
...
| Protocol | Security | Authentication Methods |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** transfer family, sftp, ftps, ftp server, custom identity provider auth, partner upload

Look for managed SFTP interfaces storing files directly in Amazon S3 for external business partner file integrations.
:::

:::warning
**Common Exam Traps:** Ensure to associate elastic IP addresses with your Transfer Family endpoints to prevent partner firewall route breakages.
:::
