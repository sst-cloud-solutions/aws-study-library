...
:::note
**Real-World Analogy:** An architect mapping a complex underground city: they check every room, map the pipes and cables connecting buildings, and document every tenant.
:::
...
| Collector Type | Agentless Collector | Agent-Based Collector |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** application discovery service, ads collector agent, server dependency mapping, agent-based discovery

Use agent-based collectors to map server dependencies, identifying which servers must be migrated together.
:::

:::warning
**Common Exam Traps:** Ensure corporate security firewalls permit outbound communication from the collector VM to AWS endpoints.
:::
...
- [Amazon WorkSpaces](../../End User Computing/Amazon WorkSpaces.md)
