...
:::note
**Real-World Analogy:** A cost estimator contractor: they inspect your current office building layouts and prepare a cost estimate showing what your monthly bills would look like in a new city.
:::
...
| Tool | Migration Evaluator | Application Discovery Service (ADS) |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** migration evaluator, cloud business case, optimized cost model projection, host sizing assessment

Use Migration Evaluator early in migration planning to secure leadership approvals for budgets.
:::

:::warning
**Common Exam Traps:** Evaluator outputs cost models, not migration plans or server configurations; it is a financial planning tool.
:::
...
- [AWS Migration Hub](AWS Migration Hub.md)
