:::note
**Real-World Analogy:** A high-speed, military-grade moving truck company: it packs your local files, validates their integrity using checklists, encrypts them, and drives them to the cloud at maximum speed over dedicated routes.
:::
...
| Migration Tool | AWS DataSync | AWS Storage Gateway |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** datasync, datasync agent, data migration, data verification, automated sync schedule

Use AWS DataSync for migrations, disaster recovery data syncs, and large analytics ingestion pipelines.
:::

:::warning
**Common Exam Traps:** DataSync requires installing an agent VM on-premises; ensure network firewall rules allow port 443 communications.
:::
