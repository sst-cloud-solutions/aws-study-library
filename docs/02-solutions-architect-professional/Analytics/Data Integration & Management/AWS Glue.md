...
:::note
**Real-World Analogy:** A translation clerk who reads varying catalog files, translates their formats into a uniform language, and logs them in a central index database.
:::
...
| Tool | AWS Glue Data Catalog | DynamoDB Metadata Table |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** aws glue, glue crawler, schema detection data catalog, spark etl job dpu

Look for "serverless ETL", "schema registry", "data cataloging", or "Apache Spark job" in the exam.
:::

:::warning
**Common Exam Traps:** Glue Crawlers can incur high costs if run too frequently on large, unchanged datasets; schedule them optimally.
:::
