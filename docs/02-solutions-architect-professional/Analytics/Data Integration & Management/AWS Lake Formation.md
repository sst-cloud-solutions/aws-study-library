...
:::note
**Real-World Analogy:** A high-security data library vault: instead of granting employees access to whole wings of files, the librarian grants permissions to read specific pages and columns.
:::
...
| Authorization Type | AWS Lake Formation | S3 Bucket Policies |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** lake formation, column level permissions, secure data lake, cell-level row filtering

Use Lake Formation to manage multi-tenant compliance environments across S3 data lakes.
:::

:::warning
**Common Exam Traps:** Lake Formation requires registering S3 paths first; unregistered paths will bypass Lake Formation security rules.
:::
...
- [Amazon Athena](../Interactive Query & Batch Processing/Amazon Athena.md)

## Related Topics

- [AWS Data Exchange](AWS Data Exchange.md)
- [AWS Glue](AWS Glue.md)
