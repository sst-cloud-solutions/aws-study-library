...
:::note
**Real-World Analogy:** A hybrid file cabinet: you keep the most frequently used folders on a small shelf in your local office (Local Cache) while archiving the massive vault of files in a secure cloud storage system.
:::
...
| Gateway Type | Target Interface | Cloud Storage Backend | Primary Use Case |
| :--- | :--- | :--- | :--- |
...
:::tip
**Exam Clues:** storage gateway, file gateway, volume gateway, tape gateway, vtl, local cache, iscsi

Use Storage Gateway to bridge legacy on-premises applications to AWS storage services without modifying application logic.
:::

:::warning
**Common Exam Traps:** File Gateway maintains a cache; modifications to S3 files directly from the cloud may not reflect locally without a `RefreshCache` API call.
:::
...
- [AWS Study Library - Content Dependency Map](../../../dependency_map.md)
