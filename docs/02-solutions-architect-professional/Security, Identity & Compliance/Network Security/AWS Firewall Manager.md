...
:::note
**Real-World Analogy:** A corporate security manager who defines a single building code standard: they ensure that every building (AWS Account) has standard security cameras and alarms installed automatically.
:::
...
| Tool | Firewall Manager | AWS Config |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** firewall manager, central security rule policy, organization-wide waf rules, compliance security groups

Use Firewall Manager to enforce a minimum baseline security group config across all developer VPCs in an Organization.
:::

:::warning
**Common Exam Traps:** Firewall Manager requires AWS Organizations to be configured with "All Features Enabled". It cannot manage standalone accounts.
:::
...
- [AWS Network Firewall](AWS Network Firewall.md)
