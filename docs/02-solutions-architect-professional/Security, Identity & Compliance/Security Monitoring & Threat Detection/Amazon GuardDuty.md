...
:::note
**Real-World Analogy:** A security guard that continuously listens to police radio logs, guest logbooks, and exit gate logs to spot signs of a break-in.
:::
...
| Resource Scope | GuardDuty | Inspector |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** guardduty, threat detection, vpc flow logs monitoring, dns query analysis, log intelligence

Enable GuardDuty centrally across all accounts in your organization using AWS Organizations delegation.
:::

:::warning
**Common Exam Traps:** GuardDuty only detects and alerts; it does not automatically resolve or block threats without configuring EventBridge Lambda actions.
:::
...
- [AWS WAF](../Network Security/AWS WAF.md)
