...
:::note
**Real-World Analogy:** A detective inspector who takes finding reports (GuardDuty findings) and builds a visual timeline map of who entered the building and what they touched to reconstruct a crime.
:::
...
:::tip
**Exam Clues:** detective, incident investigation, root cause analysis database, behavioral profile graph

Open Amazon Detective directly from GuardDuty console finding links to analyze the historical context of an attack.
:::

:::warning
**Common Exam Traps:** Detective does not perform threat detection checks; it relies on findings from GuardDuty to begin investigations.
:::
