...
:::note
**Real-World Analogy:** A safety inspector checking your server hardware: they log in, check if the software packages have known security bugs (CVEs), and verify if any doors are open.
:::
...
| Scope | Amazon Inspector | AWS Systems Manager Patch Manager |
| :--- | :--- | :--- |
...
:::tip
**Exam Clues:** inspector, software vulnerability scanning, cve check, container image scan, agentless scan

Use Amazon Inspector in CI/CD container pipelines to reject docker builds containing critical CVE vulnerabilities.
:::

:::warning
**Common Exam Traps:** Inspector reports vulnerabilities; it is the customer responsibility to trigger patches using SSM Patch Manager.
:::
