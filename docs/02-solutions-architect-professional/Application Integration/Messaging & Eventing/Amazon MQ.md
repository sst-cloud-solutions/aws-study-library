...
:::note
**Real-World Analogy:** A legacy shipping post dispatcher who speaks traditional shipping terms (JMS, AMQP) helping migrate an old post system without converting the shipping labels.
:::
...
:::tip
**Exam Clues:** amazon mq, activemq rabbitmq migration, amqp jms protocol, active standby broker

Choose Amazon MQ when migrating on-premises applications using traditional APIs (e.g. JMS, AMQP) to avoid code rewrites.
:::

:::warning
**Common Exam Traps:** Amazon MQ is not serverless; you must monitor instance disk and CPU usage to prevent message delivery blockages.
:::
