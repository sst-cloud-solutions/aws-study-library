module.exports = {
  path: 'docs/05-exam-strategy/intro.md',
  title: 'AWS Certification Exam Strategy',
  content: `# AWS Certification Exam Strategy
...
The Solutions Architect Professional exam gives you 180 minutes to answer 75 questions (~2.4 minutes per question).
